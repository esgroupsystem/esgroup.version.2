...
@section('content')
    <nav class="navbar navbar-standard navbar-expand-lg fixed-top navbar-dark"
        ...
        <div class="container">
            <a class="navbar-brand" href="#"><span class="text-white dark__text-white">Jell Group</span></a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item d-flex align-items-center me-2">
                        <div class="dropdown theme-control-dropdown landing-drop">
                            <a class="nav-link d-flex align-items-center dropdown-toggle fa-icon-wait pe-1" href="#"
                                                ...
                                                <div class="col-auto">
                                                    <div class="form-check mb-0">
                                                        <input class="form-check-input" type="checkbox" name="remember"
                                                            id="modal-checkbox" />
                                                        <label class="form-check-label mb-0" for="modal-checkbox">Remember
                                                            me</label>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                    ...
                    @else
                        {{-- Dashboard button and username aligned --}}
                        <li class="nav-item d-flex align-items-center me-2">
                            <a class="btn btn-primary text-white px-3 py-1 rounded-pill"
            ...
            <div class="modal-content">
                <div class="modal-body p-4">
                    <div class="row text-start justify-content-between align-items-center mb-2">
                        ...
                        <div class="col-auto">
                            <p class="fs-10 text-600 mb-0">Have an account? <a href="#">Login</a></p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
                <div class="col-md-11 col-lg-8 col-xl-4 pb-7 pb-xl-9 text-center text-xl-start"><a
                        class="btn btn-outline-danger mb-4 fs-10 border-2 rounded-pill" href="#!"><span
                            class="me-2" role="img" aria-label="Gift">🎁</span>Become a pro</a>
                    <h1 class="text-white fw-light">Bring <span class="typed-text fw-bold"
                            data-typed-text='["design","beauty","elegance","perfection"]'></span><br />to your webapp</h1>
                    ...
                    <a class="btn btn-outline-light border-2 rounded-pill btn-lg mt-4 fs-9 py-2" href="#!">Start
                ...
                <div class="col-xl-7 offset-xl-1 align-self-end mt-4 mt-xl-0">
                    <a class="img-landing-banner rounded">
                        <img class="img-fluid d-dark-none" src="../assets/img/generic/dashboard-alt.jpg"
                            alt="" />
                        <img class="img-fluid d-light-none" src="../assets/img/generic/dashboard-alt-dark.png"
                            alt="" />
                    </a>
                </div>
            </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    ...
                                    <p class="fs-9 text-600">- Jeff Escalante, Developer</p><img class="w-auto mx-auto"
                                        src="../assets/img/logos/netflix.png" alt="" height="30" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <button class="btn btn-outline-light border-2 rounded-pill btn-lg mt-4 fs-9 py-2" type="button">Start
                        your webapp</button>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="icon-group mt-4"><a class="icon-item bg-white text-facebook" href="#"><span
                        ...
                        <a class="icon-item bg-white text-google-plus" href="#"><span
                ...
                <div class="col ps-lg-6 ps-xl-8">
                    <div class="row mt-5 mt-lg-0">
                        ...
                        <div class="col mt-5 mt-md-0">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <h5 class="fs-9 mb-0"><a class="link-600" href="#"> Interactive graphs and
                                            charts</a></h5>
                                    <p class="text-600 opacity-50">Jan 15 &bull; 8min read </p>
                                </li>
                                <li>
                                    <h5 class="fs-9 mb-0"><a class="link-600" href="#"> Lifetime free updates</a>
                                    </h5>
                                    <p class="text-600 opacity-50">Jan 5 &bull; 3min read &starf;</p>
                                </li>
                                <li>
                                    <h5 class="fs-9 mb-0"><a class="link-600" href="#"> Merry Christmas From us</a>
                                    </h5>
                                    <p class="text-600 opacity-50">Dec 25 &bull; 2min read</p>
                                </li>
                                <li>
                                    <h5 class="fs-9 mb-0"><a class="link-600" href="#"> The New Falcon Theme</a>
                                    </h5>
            ...
            <div class="container py-3">
                <div class="row justify-content-between fs-10">
                    <div class="col-12 col-sm-auto text-center">
                        <p class="mb-0 text-600 opacity-85">Welcome to Jell Group <span class="d-none d-sm-inline-block">|
                            </span><br class="d-sm-none" /> 2025 &copy;
        ...
        <div class="modal-dialog mt-6" role="document">
            <div class="modal-content border-0">
                ...
                <div class="modal-body py-4 px-5">
                    ...
                    <div class="row g-2 mt-2">
                        <div class="col-sm-6"><a class="btn btn-outline-google-plus btn-sm d-block w-100"><span
