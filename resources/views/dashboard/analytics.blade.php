                    ...
                    <div class="card overflow-hidden mb-3">
                        <div class="card-header audience-chart-header p-0 bg-body-tertiary scrollbar-overlay">
                            <ul class="nav nav-tabs border-0 chart-tab flex-nowrap" id="audience-chart-tab" role="tablist">
                                <li class="nav-item" role="presentation"><a class="nav-link mb-0 active" id="users-tab"
                                        data-bs-toggle="tab" href="#users" role="tab" aria-controls="users"
                                        aria-selected="true">
                                ...
                                <li class="nav-item" role="presentation"><a class="nav-link mb-0" id="sessions-tab"
                                        data-bs-toggle="tab" href="#sessions" role="tab" aria-controls="sessions"
                                        aria-selected="false">
                                        <div class="audience-tab-item p-2 pe-4">
                                ...
                                <li class="nav-item" role="presentation"><a class="nav-link mb-0" id="duration-tab"
                                        data-bs-toggle="tab" href="#duration" role="tab" aria-controls="duration"
                                        aria-selected="false">
                                        <div class="audience-tab-item p-2 pe-4">
                                ...
                                <div class="col">
                                    <div class="row align-items-center">
                                        <div class="col col-lg-8">
                                            <h5 class="fs-9 mb-3 mb-sm-0 text-primary">Connect your domain to your
                ...
                <div class="col-md-6 col-xxl-4">
                    <div class="card h-100 bg-line-chart-gradient">
                        <div class="card-header bg-transparent" data-bs-theme="light">
                            ...
                            <div class="real-time-user display-1 fw-normal text-white" data-countup='{"endValue":119}'>0
                            </div>
                        </div>
                        <div class="card-body text-white fs-10 pb-0" data-bs-theme="light">
                            <p class="border-bottom pb-2" style="border-color: rgba(255, 255, 255, 0.15) !important">Page
                                views / second</p>
                        ...
                        <div class="card-footer text-end bg-transparent" data-bs-theme="light"><a class="text-white"
                                href="#!">Real-time data<span class="fa fa-chevron-right ms-1 fs-10"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xxl-4">
                        ...
                        <div class="card-body p-0">
                            <div class="scrollbar-overlay pt-0 px-x1 ask-analytics">
                                <div
                                    ...
                                    <h5 class="fs-10 text-800">Which landing pages with over 10 sessions have the
                                ...
                                <div
                                    ...
                                    <h5 class="fs-10 text-800">Show me a trend of my average page load time over the
                                        last 3 months</h5>
                                </div>
                                <div
                                    class="border border-1 border-300 rounded-2 p-3 ask-analytics-item position-relative mb-3">
                                ...
                                <div
                                    ...
                                    <h5 class="fs-10 text-800">What pages do people from California go to the most?
                                    </h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-body-tertiary text-end py-2"><a
                    ...
                    <div class="card mb-3 h-100">
                        ...
                        <div class="card-footer bg-body-tertiary py-2">
                            <div class="row flex-between-center g-0">
                                ...
                                <div class="col-auto">
                                    <h6 class="mb-0"><a class="py-2" href="#!">Active users report<span
                                                class="fas fa-chevron-right ms-1 fs-11"></span></a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-body-tertiary py-2">
                            <div class="row flex-between-center">
                                ...
                                <div class="col-auto"><a class="btn btn-link btn-sm px-0 fw-medium" href="#!">Ad
                                        campaigns<span class="fas fa-chevron-right ms-1 fs-11"></span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer bg-body-tertiary py-2">
                            <div class="row flex-between-center">
                                ...
                                <div class="col-auto"><a class="btn btn-link btn-sm px-0 fw-medium"
                                        href="#!">Overview<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table fs-10 mb-0 overflow-hidden">
                                    <thead class="bg-200">
                                        <tr>
                                            ...
                                            <th class="text-900 sort pe-x1 align-middle white-space-nowrap text-end"
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            <td class="align-middle white-space-nowrap path"><a
                                                    class="text-primary fw-semi-bold"
                                                    href="#!">/themewagon.com/themes/bootstrap-template</a></td>
                                            <td class="align-middle white-space-nowrap views text-end">11047</td>
                                            <td class="align-middle white-space-nowrap time text-end">1m:16s</td>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-body-tertiary py-2">
                            <div class="row flex-between-center g-0">
                                ...
                                <div class="col-auto"><a class="btn btn-link btn-sm px-0 fw-medium" href="#!">View
                                        full report<span class="fas fa-chevron-right ms-1 fs-11"></span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
