          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-12 order-xxl-3">
              <div class="card" id="runningProjectTable" data-list='{"valueNames":["projects","worked","time","date"]}'>
                ...
                <div class="card-body p-0">
                  <div class="scrollbar">
                    <table class="table mb-0 table-borderless fs-10 border-200 overflow-hidden table-running-project">
                      <thead class="bg-body-tertiary">
                        <tr>
                      ...
                      <tbody class="list">
                        <tr>
                          ...
                          <td class="align-middle text-center time">
                            <p class="mb-0 fw-semi-bold">12h:50m:00s</p>
                          </td>
                          <td class="align-middle text-center date">
                            <p class="mb-0 fw-semi-bold">01/02/22</p>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center time">
                            <p class="mb-0 fw-semi-bold">11h:50m:00s</p>
                          </td>
                          <td class="align-middle text-center date">
                            <p class="mb-0 fw-semi-bold">04/02/22</p>
                          </td>
                          <td>
                            <div class="avatar-group justify-content-end">
                              <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center time">
                            <p class="mb-0 fw-semi-bold">3h:30m:50s</p>
                          </td>
                          <td class="align-middle text-center date">
                            <p class="mb-0 fw-semi-bold">01/02/22</p>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center time">
                            <p class="mb-0 fw-semi-bold">12h:20m:00s</p>
                          </td>
                          <td class="align-middle text-center date">
                            <p class="mb-0 fw-semi-bold">22/03/22</p>
                          </td>
                          <td>
                            <div class="avatar-group justify-content-end">
                              <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center time">
                            <p class="mb-0 fw-semi-bold">11h:10m:00s</p>
                          </td>
                          <td class="align-middle text-center date">
                            <p class="mb-0 fw-semi-bold">28/02/22</p>
                          </td>
                          <td>
                            <div class="avatar-group justify-content-end">
                              <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center time">
                            <p class="mb-0 fw-semi-bold">12h:30m:30s</p>
                          </td>
                          <td class="align-middle text-center date">
                            <p class="mb-0 fw-semi-bold">08/01/22</p>
                          </td>
                          <td>
                            <div class="avatar-group justify-content-end">
                              <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
