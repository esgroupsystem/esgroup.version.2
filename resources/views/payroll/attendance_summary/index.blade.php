                        ...
                        <div>
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <span class="badge rounded-pill bg-light text-dark border px-3 py-2">
                                    ...
                                    {{ number_format($stats['total'] ?? 0) }} total record(s)
                                </span>

                                <span class="badge rounded-pill bg-light text-dark border px-3 py-2">
                                    <span class="fas fa-file-invoice-dollar me-1"></span>
                                    {{ number_format((float) $totalPayableDays, 2) }} payable day(s)
                                </span>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 summary-stat-card">
                        <div class="card-body">
                            ...
                            <h3 class="mb-1 stat-value">{{ number_format($presentCount) }}</h3>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 summary-stat-card">
                        <div class="card-body">
                            ...
                            <h3 class="mb-1 stat-value">{{ number_format($absentCount + $incompleteCount) }}</h3>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 summary-stat-card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-1 stat-value">{{ number_format($restDayCount) }}</h4>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 summary-stat-card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-1 stat-value">{{ number_format($leaveCount) }}</h4>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 summary-stat-card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-1 stat-value">{{ number_format((float) $totalLateMinutes, 0) }} min</h4>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 summary-stat-card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-1 stat-value">{{ number_format((float) $totalUndertimeMinutes, 0) }} min</h4>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 summary-stat-card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-1 stat-value">{{ number_format($totalWorkedMinutes / 60, 2) }} hr</h4>
