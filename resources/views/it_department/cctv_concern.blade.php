                    ...
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                        ...
                        <li class="nav-item">
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#product"
                                    ...
                                    <ul class="nav collapse" id="product">
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Add product</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                            ...
                            <!-- parent pages--><a class="nav-link dropdown-indicator" href="#e-learning" role="button"
                                ...
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                            class="fas fa-graduation-cap"></span></span><span class="nav-link-text ps-1">E
                                        learning</span><span
                                        class="badge rounded-pill ms-2 badge-subtle-success">New</span>
                                </div>
                            </a>
                            <ul class="nav collapse" id="e-learning">
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#course"
                                    ...
                                    <ul class="nav collapse" id="course">
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Course list</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Course grid</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Course details</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Create a course</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Student
                                                overview</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Trainer
                                                profile</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                            ...
                            <!-- parent pages--><a class="nav-link dropdown-indicator" href="#support-desk"
                            ...
                            <ul class="nav collapse" id="support-desk">
                                ...
                                <li class="nav-item"><a class="nav-link" href="../../app/support-desk/contacts.html">
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Contacts</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Contact
                                                details</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Tickets
                                                preview</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                ...
                                <li class="nav-item"><a class="nav-link" href="../../app/support-desk/quick-links.html">
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Quick
                                                links</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav collapse" id="Layouts">
                                <li class="nav-item"><a class="nav-link" href="../../demo/navbar-vertical.html"
                                        target="_blank">
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Navbar
                                                vertical</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                ...
                                <li class="nav-item"><a class="nav-link" href="../../demo/navbar-double-top.html"
                                        target="_blank">
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Double
                                                top</span><span
                                                class="badge rounded-pill ms-2 badge-subtle-success">New</span>
                                        </div>
                                    </a>
                        ...
                        <li class="nav-item">
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#advance"
                                    ...
                                    <ul class="nav collapse" id="advance">
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Input mask</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Range slider</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                            ...
                            <!-- parent pages--><a class="nav-link dropdown-indicator" href="#tables" role="button"
                                data-bs-toggle="collapse" aria-expanded="true" aria-controls="tables">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                            class="fas fa-table"></span></span><span
                                        class="nav-link-text ps-1">Tables</span>
                                </div>
                            </a>
                            <ul class="nav collapse show" id="tables">
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#eCharts"
                                    ...
                                    <ul class="nav collapse" id="eCharts">
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Gauge charts</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                            ...
                            <ul class="nav collapse" id="components">
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs"
                                    ...
                                    <ul class="nav collapse" id="navs-_and_-Tabs">
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Combo nav</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Sortable</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Timeline</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Treeview</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                            ...
                            <ul class="nav collapse" id="utilities">
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Focus
                                                ring</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Overlay
                                                scrollbar</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                ...
                                <li class="nav-item"><a class="nav-link" href="../../modules/utilities/ratio.html">
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Ratio</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Visually
                                                hidden</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                        ...
                                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#item-7"
                                            ...
                                            <ul class="nav collapse" id="item-7">
                                                ...
                                                <li class="nav-item"><a class="nav-link dropdown-indicator"
                                                        href="#item-9" data-bs-toggle="collapse" aria-expanded="false"
                        ...
                        <li class="nav-item">
                            ...
                            <!-- parent pages--><a class="nav-link" href="../../documentation/getting-started.html"
                                role="button">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                            class="fas fa-rocket"></span></span><span class="nav-link-text ps-1">Getting
                                        started</span>
                                </div>
                            </a>
                            ...
                            <!-- parent pages--><a class="nav-link" href="../../documentation/faq.html"
                                role="button">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                            class="fas fa-question-circle"></span></span><span
                                        class="nav-link-text ps-1">Faq</span>
                            ...
                            <!-- parent pages--><a class="nav-link" href="../../documentation/design-file.html"
                                role="button">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                            class="fas fa-palette"></span></span><span class="nav-link-text ps-1">Design
                                        file</span>
                                </div>
                            </a>
                        ...
                        <div class="card shadow-none">
                            <div class="card-body alert mb-0" role="alert">
                                ...
                                <div class="text-center"><img
                                        ...
                                        alt="" width="80" />
                                    <p class="fs-11 mt-2">Loving what you see? <br />Get your copy of <a
                                            href="#!">Falcon</a></p>
                        ...
                        <div class="search-box" data-list='{"valueNames":["title"]}'>
                            ...
                            <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                                <div class="scrollbar list py-3" style="max-height: 24rem;">
                                    ...
                                    <hr class="text-200 dark__text-900" />
                                    <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">Members
                                    ...
                                    <div class="card-body px-3">
                                        <div class="row text-center gx-0 gy-0">
                                            ...
                                            <div class="col-4"><a
                                                    ...
                                                    <p class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">Themewagon
                                                    </p>
                                                </a></div>
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                            ...
                                            <div class="col-4"><a
                                                    ...
                                                    href="#!" target="_blank"><img class="rounded"
                                                        ...
                                                        width="40" height="40" />
                                                    <p class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">Instagram
                                                    </p>
                                                </a></div>
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                    href="#!" target="_blank"><img class="rounded"
                                                        ...
                                                        width="40" height="40" />
                                                    <p class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">Pinterest
                                                    </p>
                                                </a></div>
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                            ...
                                            <div class="col-4"><a
                                                    ...
                                                    href="#!" target="_blank"><img class="rounded"
                                                        ...
                                                        width="40" height="40" />
                                                    <p class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">Deviantart
                                                    </p>
                                                </a></div>
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                ...
                <div class="card-body position-relative">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <p class="mt-2">Falcon uses <b>List.Js</b> for advance table. List.Js is a Tiny, invisible
                                and simple, yet powerful and incredibly fast vanilla JavaScript library that adds search,
                                sort, filters and flexibility to plain HTML lists, tables, or anything.</p><a
                                class="btn btn-link ps-0 btn-sm" href="https://listjs.com/" target="_blank">
                                Documentation for List.js<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-auto ms-auto">
                            <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                                <button class="btn btn-sm active" data-bs-toggle="pill"
                                    data-bs-target="#dom-1d2e3cbd-c791-4d3c-a237-fdbcf3d59fdc" type="button"
                                    role="tab" aria-controls="dom-1d2e3cbd-c791-4d3c-a237-fdbcf3d59fdc"
                                    aria-selected="true"
                                    id="tab-dom-1d2e3cbd-c791-4d3c-a237-fdbcf3d59fdc">Preview</button>
                                <button class="btn btn-sm" data-bs-toggle="pill"
                                    data-bs-target="#dom-6beca213-960e-481f-a958-f3ed45669eb7" type="button"
                                    role="tab" aria-controls="dom-6beca213-960e-481f-a958-f3ed45669eb7"
                                    aria-selected="false"
                                    id="tab-dom-6beca213-960e-481f-a958-f3ed45669eb7">Code</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            aria-labelledby="tab-dom-1d2e3cbd-c791-4d3c-a237-fdbcf3d59fdc"
                            id="dom-1d2e3cbd-c791-4d3c-a237-fdbcf3d59fdc">
                            <div id="tableExample"
                        ...
                        <div class="tab-pane code-tab-pane" role="tabpanel"
                            aria-labelledby="tab-dom-6beca213-960e-481f-a958-f3ed45669eb7"
                            id="dom-6beca213-960e-481f-a958-f3ed45669eb7">
...
&lt;/div&gt;</code></pre>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row flex-between-end">
                        <div class="col-auto align-self-center">
                            ...
                            <p class="mb-0 pt-1 mt-2 mb-0">Add <code> pagination </code> class for enable number
                                pagination. The following structure will enable number pagination with next and previous
                                button.</p>
                        </div>
                        <div class="col-auto ms-auto">
                            <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                                <button class="btn btn-sm active" data-bs-toggle="pill"
                                    data-bs-target="#dom-ee4d94a9-8a19-4a45-95ee-db21f68e2a2d" type="button"
                                    role="tab" aria-controls="dom-ee4d94a9-8a19-4a45-95ee-db21f68e2a2d"
                                    aria-selected="true"
                                    id="tab-dom-ee4d94a9-8a19-4a45-95ee-db21f68e2a2d">Preview</button>
                                <button class="btn btn-sm" data-bs-toggle="pill"
                                    data-bs-target="#dom-b7a8e8b6-d1b1-4d02-8f84-783feeb20699" type="button"
                                    role="tab" aria-controls="dom-b7a8e8b6-d1b1-4d02-8f84-783feeb20699"
                                    aria-selected="false"
                                    id="tab-dom-b7a8e8b6-d1b1-4d02-8f84-783feeb20699">Code</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            aria-labelledby="tab-dom-ee4d94a9-8a19-4a45-95ee-db21f68e2a2d"
                            id="dom-ee4d94a9-8a19-4a45-95ee-db21f68e2a2d">
                        ...
                        <div class="tab-pane code-tab-pane" role="tabpanel"
                            aria-labelledby="tab-dom-b7a8e8b6-d1b1-4d02-8f84-783feeb20699"
                            id="dom-b7a8e8b6-d1b1-4d02-8f84-783feeb20699">
...
&lt;/div&gt;</code></pre>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row flex-between-end">
                        <div class="col-auto align-self-center">
                            <h5 class="mb-0" data-anchor="data-anchor">Search Example</h5>
                            <p class="mb-0 pt-1 mt-2 mb-0">Add <code> search </code> class for enable data searching. The
                                following structure will enable search feature.</p>
                        </div>
                        <div class="col-auto ms-auto">
                            <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                                <button class="btn btn-sm active" data-bs-toggle="pill"
                                    data-bs-target="#dom-3518c112-60aa-477c-b3ab-0aabac6fa7f0" type="button"
                                    role="tab" aria-controls="dom-3518c112-60aa-477c-b3ab-0aabac6fa7f0"
                                    aria-selected="true"
                                    id="tab-dom-3518c112-60aa-477c-b3ab-0aabac6fa7f0">Preview</button>
                                <button class="btn btn-sm" data-bs-toggle="pill"
                                    data-bs-target="#dom-4440ddc9-560b-4453-9748-f789de7ddb41" type="button"
                                    role="tab" aria-controls="dom-4440ddc9-560b-4453-9748-f789de7ddb41"
                                    aria-selected="false"
                                    id="tab-dom-4440ddc9-560b-4453-9748-f789de7ddb41">Code</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            aria-labelledby="tab-dom-3518c112-60aa-477c-b3ab-0aabac6fa7f0"
                            id="dom-3518c112-60aa-477c-b3ab-0aabac6fa7f0">
                        ...
                        <div class="tab-pane code-tab-pane" role="tabpanel"
                            aria-labelledby="tab-dom-4440ddc9-560b-4453-9748-f789de7ddb41"
                            id="dom-4440ddc9-560b-4453-9748-f789de7ddb41">
                            <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div id=&quot;tableExample3&quot; data-list='{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;age&quot;],&quot;page&quot;:5,&quot;pagination&quot;:true}'&gt;
  &lt;div class=&quot;row justify-content-end g-0&quot;&gt;
    &lt;div class=&quot;col-auto col-sm-5 mb-3&quot;&gt;
      &lt;form&gt;
        &lt;div class=&quot;input-group&quot;&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row flex-between-end">
                        ...
                        <div class="col-auto ms-auto">
                            <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                                <button class="btn btn-sm active" data-bs-toggle="pill"
                                    data-bs-target="#dom-04d43baa-11f6-4b50-b5b6-ca1652a7fd5f" type="button"
                                    role="tab" aria-controls="dom-04d43baa-11f6-4b50-b5b6-ca1652a7fd5f"
                                    aria-selected="true"
                                    id="tab-dom-04d43baa-11f6-4b50-b5b6-ca1652a7fd5f">Preview</button>
                                <button class="btn btn-sm" data-bs-toggle="pill"
                                    data-bs-target="#dom-9d3db88b-0942-4b62-80b6-d1a34a3be922" type="button"
                                    role="tab" aria-controls="dom-9d3db88b-0942-4b62-80b6-d1a34a3be922"
                                    aria-selected="false"
                                    id="tab-dom-9d3db88b-0942-4b62-80b6-d1a34a3be922">Code</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0 px-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            aria-labelledby="tab-dom-04d43baa-11f6-4b50-b5b6-ca1652a7fd5f"
                            id="dom-04d43baa-11f6-4b50-b5b6-ca1652a7fd5f">
                            <div id="tableExample4" data-list='{"valueNames":["name","country","email","payment"]}'>
                                <div class="row justify-content-end justify-content-end gx-3 gy-0 px-3">
                                    <div class="col-sm-auto">
                                        <select class="form-select form-select-sm mb-3" data-list-filter="country">
                                    ...
                                    <div class="col-sm-auto">
                                        <select class="form-select form-select-sm mb-3" data-list-filter="payment">
                                        ...
                                        <tbody class="list" id="table-purchase-body">
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">Sylvia Plath</a>
                                                </th>
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">Edgar Allan
                                                        Poe</a></th>
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">William Butler
                                                        Yeats</a></th>
                                                <td class="align-middle white-space-nowrap country">USA</td>
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">Rabindranath
                                                        Tagore</a></th>
                                                <td class="align-middle white-space-nowrap country">canada</td>
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">Emily
                                                        Dickinson</a></th>
                                                <td class="align-middle white-space-nowrap country">UK</td>
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">Giovanni
                                                        Boccaccio</a></th>
                                                <td class="align-middle white-space-nowrap country">USA</td>
                                                <td class="align-middle white-space-nowrap email">giovanni@outlook.com
                                                </td>
                                                <td class="align-middle text-end fs-9 white-space-nowrap payment"><span
                                                        class="badge badge rounded-pill badge-subtle-warning">Pending<span
                                                            class="ms-1 fas fa-stream"
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">Oscar Wilde</a>
                                                </th>
                                                <td class="align-middle white-space-nowrap country">USA</td>
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">John Doe</a>
                                                </th>
                                                <td class="align-middle white-space-nowrap country">canada</td>
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <th class="align-middle white-space-nowrap name"><a
                                                        href="../../app/e-commerce/customer-details.html">Emma Watson</a>
                                                </th>
                                                <td class="align-middle white-space-nowrap country">UK</td>
                            ...
                            <div class="p-3">
                                <p>Use <code>data-list-filter </code>attribute with the select fields and assign the value
                                    according to the column name. For example</p>
                        ...
                        <div class="tab-pane code-tab-pane" role="tabpanel"
                            aria-labelledby="tab-dom-9d3db88b-0942-4b62-80b6-d1a34a3be922"
                            id="dom-9d3db88b-0942-4b62-80b6-d1a34a3be922">
                            <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div id=&quot;tableExample4&quot; data-list='{&quot;valueNames&quot;:[&quot;name&quot;,&quot;country&quot;,&quot;email&quot;,&quot;payment&quot;]}'&gt;
  &lt;div class=&quot;row justify-content-end justify-content-end gx-3 gy-0 px-3&quot;&gt;
    &lt;div class=&quot;col-sm-auto&quot;&gt;
      &lt;select class=&quot;form-select form-select-sm mb-3&quot; data-list-filter=&quot;country&quot;&gt;
        &lt;option selected=&quot;&quot; value=&quot;&quot;&gt;Select country&lt;/option&gt;
    ...
    &lt;table class=&quot;table table-sm table-striped fs-10 mb-0 overflow-hidden&quot;&gt;
      ...
      &lt;tbody class=&quot;list&quot; id=&quot;table-purchase-body&quot;&gt;
        &lt;tr class=&quot;btn-reveal-trigger&quot;&gt;
          ...
          &lt;td class=&quot;align-middle white-space-nowrap country&quot;&gt;USA&lt;/td&gt;
          &lt;td class=&quot;align-middle white-space-nowrap email&quot;&gt;john@gmail.com&lt;/td&gt;
          &lt;td class=&quot;align-middle text-end fs-9 white-space-nowrap payment&quot;&gt;&lt;span class=&quot;badge badge rounded-pill badge-subtle-success&quot;&gt;Success&lt;span class=&quot;ms-1 fas fa-check&quot; data-fa-transform=&quot;shrink-2&quot;&gt;&lt;/span&gt;&lt;/span&gt;
          &lt;/td&gt;
        &lt;/tr&gt;
        &lt;tr class=&quot;btn-reveal-trigger&quot;&gt;
          ...
          &lt;td class=&quot;align-middle white-space-nowrap country&quot;&gt;canada&lt;/td&gt;
          &lt;td class=&quot;align-middle white-space-nowrap email&quot;&gt;sylvia@mail.ru&lt;/td&gt;
          &lt;td class=&quot;align-middle text-end fs-9 white-space-nowrap payment&quot;&gt;&lt;span class=&quot;badge badge rounded-pill badge-subtle-warning&quot;&gt;Pending&lt;span class=&quot;ms-1 fas fa-stream&quot; data-fa-transform=&quot;shrink-2&quot;&gt;&lt;/span&gt;&lt;/span&gt;
          &lt;/td&gt;
        &lt;/tr&gt;
        &lt;tr class=&quot;btn-reveal-trigger&quot;&gt;
          ...
          &lt;td class=&quot;align-middle white-space-nowrap country&quot;&gt;UK&lt;/td&gt;
          &lt;td class=&quot;align-middle white-space-nowrap email&quot;&gt;edgar@yahoo.com&lt;/td&gt;
          &lt;td class=&quot;align-middle text-end fs-9 white-space-nowrap payment&quot;&gt;&lt;span class=&quot;badge badge rounded-pill badge-subtle-secondary&quot;&gt;Blocked&lt;span class=&quot;ms-1 fas fa-ban&quot; data-fa-transform=&quot;shrink-2&quot;&gt;&lt;/span&gt;&lt;/span&gt;
          &lt;/td&gt;
        &lt;/tr&gt;
        &lt;tr class=&quot;btn-reveal-trigger&quot;&gt;
...
&lt;/div&gt;
&lt;div class=&quot;p-3&quot;&gt;
  &lt;p&gt;Use &lt;code&gt;data-list-filter &lt;/code&gt;attribute with the select fields and assign the value according to the column name. For example&lt;/p&gt;
  &lt;pre class=&quot;scrollbar mt-2&quot;&gt;&lt;code class=&quot;language-html&quot;&gt;&amp;lt;select class=&amp;quot;form-select form-select-sm mb-3&amp;quot; data-list-filter=&amp;quot;country&amp;quot;&amp;gt;&amp;lt;/select&amp;gt;&lt;/code&gt;&lt;/pre&gt;
&lt;/div&gt;</code></pre>
                        </div>
                    </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body bg-body-tertiary">
                    ...
                    <ul>
                        <li>Set unique ID and add <code>data-list </code>attribute to the wrapper element and list your
                            column in <code>valueNames </code>property.
...
&lt;/div&gt;</code></pre>
                        ...
                        <li>To enable sorting in your column, add <code>data-sort </code>attribute and assign column name to
                            the attribute.
...
&lt;/tbody&gt;</code></pre>
                        ...
                        <li>Then wrap your value with column name as a class. For example, if your column name is <code>name
                            </code>then the value will be look like this:
                            <pre class="scrollbar mt-2"><code class="language-html">&lt;td class=&quot;name&quot;&gt;John Doe&lt;/td&gt;</code></pre>
                        </li>
                        <li>To add pagination <code>.pagination </code>class inside your wrapper element</li>
                        <li>To enable button pagination add <code>data-list-pagination='prev' </code>and
                            <code>data-list-pagination='next' </code>to the "Prev" and "Next" buttons respectively.</li>
                        <li>To enable search feature add <code>search </code>class in <code>input </code>tag.</li>
                        <li>To see the list info, add <code>data-list-info </code> attribute to a DOM element inside your
                            wrapper element.</li>
                    </ul>
                </div>
            </div>
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row flex-between-end">
                        <div class="col-auto align-self-center">
                            <h5 class="mb-0" data-anchor="data-anchor">Ajax Table</h5>
                            <p class="mb-0 pt-1 mt-2 mb-0">This is an example of Advanced Table using external Data.</p>
                        </div>
                        <div class="col-auto ms-auto">
                            <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                                <button class="btn btn-sm active" data-bs-toggle="pill"
                                    data-bs-target="#dom-8ae3e580-802d-4b9c-8e92-678ee6161ca5" type="button"
                                    role="tab" aria-controls="dom-8ae3e580-802d-4b9c-8e92-678ee6161ca5"
                                    aria-selected="true"
                                    id="tab-dom-8ae3e580-802d-4b9c-8e92-678ee6161ca5">Preview</button>
                                <button class="btn btn-sm" data-bs-toggle="pill"
                                    data-bs-target="#dom-c80e3555-d605-42e1-83fe-14c3b1ec2652" type="button"
                                    role="tab" aria-controls="dom-c80e3555-d605-42e1-83fe-14c3b1ec2652"
                                    aria-selected="false"
                                    id="tab-dom-c80e3555-d605-42e1-83fe-14c3b1ec2652">Code</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0 px-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            aria-labelledby="tab-dom-8ae3e580-802d-4b9c-8e92-678ee6161ca5"
                            id="dom-8ae3e580-802d-4b9c-8e92-678ee6161ca5">
                                ...
                                <div class="table-responsive scrollbar mb-3">
                                    <table class="table table-sm table-striped fs-10 mb-0 overflow-hidden">
                                        <thead class="bg-200">
                                            <tr>
                                                <th class="text-900 sort pe-1 align-middle white-space-nowrap"
                                                    data-sort="orderId">Order</th>
                                                <th class="text-900 sort pe-1 align-middle white-space-nowrap pe-7"
                            ...
                            <div class="card-body">
                                ...
                                <ul>
                                    ...
                                    <li>Use the <code>advanceAjaxTableInit() </code>function from
                                        <code>src/js/theme/advance-ajax-table.js </code>in a new JS file and update the ID.
                                    </li>
                                ...
                                <ul>
                                    <li>Give your table a unique ID.</li>
                                    <li>Find the <code>advanceAjaxTableInit() </code>function from <code>theme.js,
                                        </code>copy the code, and update the ID in a new function.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="tab-pane code-tab-pane" role="tabpanel"
                            aria-labelledby="tab-dom-c80e3555-d605-42e1-83fe-14c3b1ec2652"
                            id="dom-c80e3555-d605-42e1-83fe-14c3b1ec2652">
                            <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;table-list&quot; id=&quot;advanceAjaxTable&quot;&gt;
  &lt;div class=&quot;table-responsive scrollbar mb-3&quot;&gt;
    &lt;table class=&quot;table table-sm table-striped fs-10 mb-0 overflow-hidden&quot;&gt;
      &lt;thead class=&quot;bg-200&quot;&gt;
        &lt;tr&gt;
