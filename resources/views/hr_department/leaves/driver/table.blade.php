<div class="table-responsive scrollbar">
    <table class="table table-sm table-hover align-middle fs-10 mb-0 w-100 driver-leave-table">
        <thead class="bg-200 text-900">
            <tr>
                <th style="min-width: 230px;">Employee / Driver</th>
...
<style>
    ...
    .driver-leave-table .notice-step.done .notice-dot {
        background: var(--falcon-info, #27bcfd);
    }

    .driver-leave-table .notice-step.inactive-step {
        color: var(--falcon-warning, #f5803e);
    }

    .driver-leave-table .notice-step.inactive-step .notice-dot {
        background: var(--falcon-warning, #f5803e);
    }

    .driver-leave-table .notice-step.final-step {
        color: var(--falcon-danger, #e63757);
    }

    .driver-leave-table .notice-step.final-step .notice-dot {
