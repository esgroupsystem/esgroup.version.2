            ...
            <div class="alert alert-info border-0 shadow-sm mb-4">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-0">
                            The table now shows each driver's assigned garage. Once the driver reaches the 2nd Notice,
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="workflow-step border rounded-3 p-3 h-100">
                                        ...
                                        <p class="text-700 small mb-0">
                                            Used when driver is past leave period and needs first warning.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="small text-700">
                                <strong>Note:</strong> Use “Ready for Duty” only when the driver has already returned and is
                                cleared to work.
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function bindActionModal() {
                ...
                document.querySelectorAll('.action-open-modal').forEach(button => {
                    button.addEventListener('click', function(event) {
                        ...
                        modalForm.action = "{{ route('driver-leave.driver.action', ':id') }}"
                            .replace(':id', id);
                        ...
                        if (action === 'second') {
                            ...
                            subtitle.innerText =
                                'This will automatically deactivate the driver record.';
            ...
            document.addEventListener('click', function(event) {
                const link = event.target.closest('#driverLeaveTable .pagination a');
