                ...
                <div class="card-body position-relative">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <p class="text-muted">Manage leaves for drivers — HR will approve automatically. Use actions to
            ...
            <div class="card mb-4">
                ...
                <div class="p-3">
                    <div class="row g-3 align-items-center">
                        <div class="col-md-4">
                            <input class="form-control form-control-sm search" placeholder="Search driver leave...">
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('driver-leave.driver.edit', $leave->id) }}">
...
@push('scripts')
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const table = new List("driverLeaveTable", {
            ...
            document.querySelectorAll('.action-open-modal').forEach(a => {
                a.addEventListener('click', function(e) {
                    ...
                    // set modal form action (POST to route driver-leave.action)
                    modalForm.action = "{{ route('driver-leave.driver.action', ':id') }}".replace(
                        ':id', id);
