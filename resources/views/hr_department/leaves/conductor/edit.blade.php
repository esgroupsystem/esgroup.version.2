            ...
            <div class="card mb-4 overflow-hidden">
                ...
                <div class="card-body position-relative">
                    <div class="row align-items-center g-3">
                        <div class="col-lg-8">
                            <h3 class="mb-1">Edit Conductor Leave</h3>
                            <p class="text-700 mb-0">
                                Update conductor leave details, garage assignment visibility, and HR notes.
                            </p>
                        </div>
                                        ...
                                        <select name="employee_id" id="employee_id"
                                            ...
                                            @foreach ($conductors as $conductor)
                                                <option value="{{ $conductor->id }}" data-name="{{ $conductor->full_name }}"
                                                    ...
                                                    {{ old('employee_id', $leave->employee_id) == $conductor->id ? 'selected' : '' }}>
                                                    {{ $conductor->full_name }}
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="small text-700">
                                    2nd Notice automatically makes the conductor <strong>Inactive</strong>.
                                </div>
                            </div>
                        </div>
...
@push('styles')
    <style>
        ...
        .conductor-leave-form-page .notice-list {
            display: flex;
            flex-direction: column;
            gap: .85rem;
        }

        .conductor-leave-form-page .notice-line {
            display: flex;
