                            ...
                            <div class="notice-step {{ $leave->first_notice_sent_at ? 'done' : '' }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    @if ($leave->first_notice_proof)
                                        <a href="{{ route('conductor-leave.conductor.proof', [$leave, 'first']) }}"
                                            target="_blank" rel="noopener" class="notice-proof-link mt-1">
                                            <img src="{{ route('conductor-leave.conductor.proof', [$leave, 'first']) }}"
                            ...
                            <div class="notice-step {{ $leave->second_notice_sent_at ? 'done inactive-step' : '' }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    @if ($leave->second_notice_proof)
                                        <a href="{{ route('conductor-leave.conductor.proof', [$leave, 'second']) }}"
                                            target="_blank" rel="noopener" class="notice-proof-link mt-1">
                                            <img src="{{ route('conductor-leave.conductor.proof', [$leave, 'second']) }}"
                            ...
                            <div class="notice-step {{ $leave->final_notice_sent_at ? 'done final-step' : '' }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    @if ($leave->final_notice_proof)
                                        <a href="{{ route('conductor-leave.conductor.proof', [$leave, 'final']) }}"
                                            target="_blank" rel="noopener" class="notice-proof-link mt-1">
                                            <img src="{{ route('conductor-leave.conductor.proof', [$leave, 'final']) }}"
                    ...
                    <td class="text-center">
                        <div class="dropdown font-sans-serif position-static">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    ...
                                    @else
                                        <a class="dropdown-item"
                                            href="{{ route('conductor-leave.conductor.edit', $leave) }}">
                                ...
                                @if ($canShowReady)
                                    <li>
                                        <a class="dropdown-item conductor-action-open-modal" href="#"
                                            data-url="{{ route('conductor-leave.conductor.action', $leave) }}"
                    ...
                    <td colspan="8" class="text-center py-5">
                        <div class="empty-state">
                            ...
                            <p class="text-600 mb-0">
                                Create a new conductor leave record or adjust your search.
                            </p>
                        </div>
                    </td>
                </tr>
...
<style>
    ...
    .conductor-leave-table .notice-proof-link {
        display: inline-flex;
        align-items: center;
        gap: .45rem;
        margin-top: .25rem;
    ...
    .conductor-leave-table .notice-proof-thumb {
        width: 42px;
        height: 42px;
        object-fit: cover;
    ...
    .conductor-leave-table .dropdown-item.disabled {
        pointer-events: none;
        opacity: .55;
    }
