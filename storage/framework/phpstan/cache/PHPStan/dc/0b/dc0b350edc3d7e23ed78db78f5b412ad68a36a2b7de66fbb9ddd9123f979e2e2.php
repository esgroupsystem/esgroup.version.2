...
// phpinternal-PHPStan\BetterReflection\Reflection\ReflectionClass-error
 ...
 */',
    ...
    array (
      'message' => 
      array (
        'declaringClassName' => 'Error',
        'implementingClassName' => 'Error',
        'name' => 'message',
        'modifiers' => 2,
        'type' => NULL,
        'default' => NULL,
        'docComment' => '/** The error message */',
        'attributes' => 
        array (
        ),
        'startLine' => 12,
      ...
      array (
        ...
        'default' => NULL,
        'docComment' => '/** The filename where the error happened  */',
        'attributes' => 
        array (
          0 => 
          array (
      ...
      array (
        ...
        'default' => NULL,
        'docComment' => '/** The line where the error happened */',
        'attributes' => 
        array (
          0 => 
          array (
      ...
      array (
        ...
        'docComment' => '/** Cached string representation of the error (used by __toString) */',
        'attributes' => 
        array (
        ),
        'startLine' => 22,
      ...
      array (
        ...
        'docComment' => '/** Internal storage for the error stack trace */',
        'attributes' => 
        array (
        ),
        'startLine' => 24,
      ...
      array (
        ...
        'docComment' => '/** The previous throwable used for error chaining */',
        'attributes' => 
        array (
        ),
        'startLine' => 26,
