                            ...
                            <div class="p-4 p-md-5 flex-grow-1">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-auto">
                                        <div class="d-md-flex align-items-center text-center text-md-start">
                                            ...
                                            <div class="avatar avatar-4xl me-4">
                                                <img class="rounded-circle"
                                                     src="<?php echo e(Auth::user()->profile_picture ?? asset('assets/img/team/default.jpg')); ?>"
                                                     alt="User Avatar">
                                            </div>
                                        ...
                                        <form class="mt-4 row gx-2" method="POST" action="<?php echo e(route('lockscreen.unlock')); ?>">
                                            <?php echo csrf_field(); ?>
