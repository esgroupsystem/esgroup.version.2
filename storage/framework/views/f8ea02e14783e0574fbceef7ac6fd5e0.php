<?php $__env->startSection('title', 'Items Management'); ?>
        ...
        <div class="content">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-0">
                    <div id="itemTable">
                        <?php echo $__env->make('maintenance.items.items_table', ['items' => $items], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content border-0 shadow-sm">
                ...
                <div class="modal-body bg-100">
                    <div id="stockTableContainer">
                        <?php echo $__env->make('maintenance.items.stock_table', ['products' => $stock], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\esgroup.version.2\resources\views/maintenance/items/index.blade.php ENDPATH**/ ?>