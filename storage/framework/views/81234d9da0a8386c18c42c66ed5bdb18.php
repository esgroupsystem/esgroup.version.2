<?php $__env->startSection('title', 'Dashboard | Jell Group'); ?>
                ...
                ">
                        ...
                        <div class="card-body position-relative py-5 px-4 px-md-5">
                            ...
                            <h2 class="fw-bold text-primary mb-2">
                                <?php echo e($greeting); ?>, <?php echo e(Auth::user()->full_name); ?>! 👋
                            </h2>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h6 class="mb-0 fw-semibold">
                                                <?php echo e(Auth::user()->last_online ? Auth::user()->last_online->format('M d, Y h:i A') : 'N/A'); ?>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h6 class="mb-0 fw-semibold text-info text-capitalize">
                                                <?php echo e(Auth::user()->account_status); ?>
    ...
    <div class="modal fade" id="forceChangePasswordModal" tabindex="-1">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('auth.change.password.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\esgroup.version.2\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>