        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
            <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5">
                ...
                <a class="d-flex flex-center mb-4" href="/">
                    <img class="me-2" src="<?php echo e(asset('assets/img/icons/spot-illustrations/falcon.png')); ?>" width="58" alt="">
                ...
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <a class="btn btn-primary btn-sm mt-3" href="<?php echo e(route('dashboard.index')); ?>">
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\esgroup.version.2\resources\views/errors/404.blade.php ENDPATH**/ ?>