        ...
        <div class="content">
                ...
                <div class="card-body bg-body-tertiary">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('stock-transfers.create')); ?>" class="btn btn-primary btn-sm">
            ...
            <div class="card border-0 shadow-sm">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4 col-lg-6 text-md-end">
                            <span class="badge badge-subtle-warning px-3 py-2 fs-10">
                                Total Records: <?php echo e($transfers->total()); ?>
                ...
                <div id="transferTableWrapper">
                    <?php echo $__env->make('maintenance.stock_transfers.table', ['transfers' => $transfers], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadTransfers(url = null) {
                ...
                const requestUrl = url ||
                    `<?php echo e(route('stock-transfers.index')); ?>?search=${encodeURIComponent(search)}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\esgroup.version.2\resources\views/maintenance/stock_transfers/index.blade.php ENDPATH**/ ?>