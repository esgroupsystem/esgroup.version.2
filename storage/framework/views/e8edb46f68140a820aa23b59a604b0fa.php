                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 col-xl">
                            <div class="border rounded-3 p-3 h-100 bg-info-subtle border-info">
                                ...
                                <h5 class="mb-0 text-info fw-bold">₱ <?php echo e(number_format($holidayPay, 2)); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl">
                            <div class="border rounded-3 p-3 h-100 bg-warning-subtle border-warning">
                                ...
                                <h5 class="mb-0 text-warning fw-bold">₱ <?php echo e(number_format($restDayPay, 2)); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl">
                            <div class="border rounded-3 p-3 h-100 bg-secondary-subtle border-secondary">
                                ...
                                <h5 class="mb-0 text-secondary fw-bold">₱ <?php echo e(number_format($totalAdditions, 2)); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl">
                            <div class="border rounded-3 p-3 h-100 bg-success-subtle border-success">
                                ...
                                <h5 class="mb-0 text-success fw-bold">₱ <?php echo e(number_format($grossWithAdditions, 2)); ?></h5>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end text-info fw-semibold">
                                                + ₱ <?php echo e(number_format($holidayPay, 2)); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end text-warning fw-semibold">
                                                + ₱ <?php echo e(number_format($restDayPay, 2)); ?>
                                        ...
                                        <?php if($leavePay > 0): ?>
                                            <tr>
                                                ...
                                                <td class="text-end text-secondary fw-semibold">
                                                    + ₱ <?php echo e(number_format($leavePay, 2)); ?>
                                        ...
                                        <tr class="table-light">
                                            ...
                                            <td class="text-end fw-bold text-info">
                                                ₱ <?php echo e(number_format($grossWithAdditions, 2)); ?>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <h6 class="mb-0 text-primary">₱ <?php echo e(number_format($allowancePerCutoff, 2)); ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <h6 class="mb-0 text-info">₱ <?php echo e(number_format($holidayPay, 2)); ?></h6>
                                        <?php if($totalHolidayWorked > 0): ?>
                                            <small class="text-muted">
                                                <?php echo e($totalHolidayWorked); ?> holiday worked day(s)
                                            </small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <h6 class="mb-0 text-warning">₱ <?php echo e(number_format($restDayPay, 2)); ?></h6>
                                        <?php if($totalRestDayWorked > 0): ?>
                                            <small class="text-muted">
                                                <?php echo e($totalRestDayWorked); ?> rest day worked day(s)
                                            </small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <h6 class="mb-0 text-secondary">₱ <?php echo e(number_format($leavePay, 2)); ?></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold text-success fs-6">
                                    ₱ <?php echo e(number_format($totalAdditions, 2)); ?>
