<?php $__env->startSection('title', 'New Parts Out'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container" data-layout="container">
        ...
        <div class="content">
            <form action="<?php echo e(route('parts-out.store')); ?>" method="POST" enctype="multipart/form-data" id="partsOutForm">
                <?php echo csrf_field(); ?>
                                ...
                                <select name="vehicle_id" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($vehicle->id); ?>"
                                            ...
                                            <?php echo e($vehicle->plate_number ?? 'N/A'); ?>

                                            <?php if(!empty($vehicle->body_number)): ?>
                                                | <?php echo e($vehicle->body_number); ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('input', function(e) {
                ...
                searchTimeout = setTimeout(() => {
                    ...
                    fetch(`<?php echo e(route('parts-out.search-products')); ?>?search=${encodeURIComponent(keyword)}&location_id=${encodeURIComponent(locationId)}&exclude_ids=${encodeURIComponent(selectedIds.join(','))}`, {
                            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\esgroup.version.2\resources\views/maintenance/parts_out/create.blade.php ENDPATH**/ ?>