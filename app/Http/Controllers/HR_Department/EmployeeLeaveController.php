...
class EmployeeLeaveController extends Controller
{
    public function index(Request $request)
    {
        ...
        $counts = ['active' => 0, 'first' => 0, 'second' => 0, 'termination' => 0];
        ...
        return view('hr_department.leaves.employee.index', compact('leaves', 'counts', 'today'));
    }

    public function action(Request $request, EmployeeLeave $leave)
    {
