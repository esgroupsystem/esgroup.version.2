        ...
        },
        {
            ...
            value: function data(key) {
                if (this.isValidNode()) {
                    try {
                        return JSON.parse(
                            this.node.dataset[this.camelize(key)]
                        );
                    } catch (e) {
...
var advanceAjaxTableInit = function advanceAjaxTableInit() {
    ...
    if (table) {
        ...
        var paginationButtonNext = table.querySelector(
            '[data-list-pagination="next"]'
        );
        var paginationButtonPrev = table.querySelector(
        ...
        [
            ...
            },
            {
                ...
                value: function attachNodes() {
                    var _utils$getData = utils.getData(
                            this.element,
                            "bulk-select"
                        ),
                ...
                value: function clickBulkCheckbox() {
                    ...
                    this.element.addEventListener("click", function () {
                        ...
                        if (_this.element.checked) {
                            _this.actions.removeClass(
                                _this.option.displayNoneClassName
                            );
                            _this.replacedElement.addClass(
                                _this.option.displayNoneClassName
                            );
                        } else {
                            _this.actions.addClass(
                ...
                value: function clickRowCheckbox() {
                    ...
                    this.bulkSelectRows.forEach(function (el) {
                        ...
                        rowCheck.on("click", function () {
                            if (
                                _this2.element.indeterminate !== "indeterminate"
                            ) {
                            ...
                            if (
                                _toConsumableArray(_this2.bulkSelectRows).every(
                                    function (element) {
...
var chatInit = function chatInit() {
    ...
    document
        .querySelectorAll(Selector.CONTACTS_LIST_SHOW)
        .forEach(function (el) {
                        ...
                        .forEach(function (choicesItem) {
                            ...
                            if (choicesItem.querySelector("[required]")) {
                                if (singleSelect) {
                                    ...
                                    if (
                                        ((_singleSelect$querySe =
                                            singleSelect.querySelector(
                                                ".choices__item--selectable"
                                            )) === null ||
                                        _singleSelect$querySe === void 0
                                            ? void 0
                                            : _singleSelect$querySe.getAttribute(
                                                  "data-value"
                                              )) !== ""
                                    ) {
                                ...
                                if (multipleSelect) {
                                    if (
                                        choicesItem.getElementsByTagName(
                                            "option"
                                        ).length
                                    ) {
                                        choicesItem.classList.remove("invalid");
    ...
    if (dateTimePickers.length && window.flatpickr) {
        dateTimePickers.forEach(function (item) {
            ...
            function findDefaultRange(defaultRange, userRange) {
                return (
                    defaultRange.find(function (rangeItem) {
                        return rangeItem.id === userRange;
                    }) || null
                );
            }
            function generateRangeButtons(predefinedDefaultRanges) {
                var userDefinedRanges =
                    arguments.length > 1 && arguments[1] !== undefined
                        ? arguments[1]
                        : [];
                var normalizedUserRanges = Array.isArray(userDefinedRanges)
                    ? userDefinedRanges
                    : predefinedDefaultRanges;
                var mergedRanges = normalizedUserRanges
                    .map(function (userRange) {
                        if (_typeof(userRange) === "object") {
                            return applyUserRange(
                                predefinedDefaultRanges,
                                userRange
                            );
                        }
                        return findDefaultRange(
                            predefinedDefaultRanges,
                            userRange
                        );
                    })
            ...
            function addRangeButtonClickListeners(instance, calendarContainer) {
                _toConsumableArray(
                    calendarContainer.querySelectorAll("[data-range]")
                ).map(function (btn) {
                    return btn.addEventListener("click", function () {
                        var startDate = new Date(
                            utils.getData(btn, "range").split(",")[0]
                        );
                        var endDate = new Date(
                            utils.getData(btn, "range").split(",")[1]
                        );
            ...
            function initializeFlatpickr(element, options) {
                function showPredefinedRanges(
                    ...
                    if (options.predefinedRanges) {
                        ...
                        var rangeButtonsHtml = generateRangeButtons(
                            defaultPredefinedRanges,
                            options.predefinedRanges
                        );
                        appendRangeButtonsIfNotExists(
                            calendarContainer,
                            rangeButtonsHtml
                        );
                        addRangeButtonClickListeners(
                            instance,
                            calendarContainer
                        );
                    }
                }
                function hidePredefinedRanges(
                    selectedDates,
                    dateStr,
                    instance
                ) {
...
var kanbanInit = function kanbanInit() {
    ...
    addCardButtons &&
        addCardButtons.forEach(function (button) {
            button.addEventListener(Events.CLICK, function (_ref5) {
                ...
                var container = column.querySelector(
    ...
    collapseDismissButtons.forEach(function (button) {
        button.addEventListener(Events.CLICK, function (_ref9) {
            ...
            utils.hasClass(
                collapseElement.nextElementSibling,
                ClassNames.D_NONE
            ) &&
                collapseElement.nextElementSibling.classList.remove(
                    ClassNames.D_NONE
                );
            collapse.hide();
        });
    ...
    if (window.List) {
        ...
        if (lists.length) {
            lists.forEach(function (el) {
                ...
                var listFilters =
                    document.querySelectorAll("[data-list-filter]");
                ...
                var pageCount = 1;
                btnDropdownClose &&
                    btnDropdownClose.addEventListener(
                        "search.close",
                        function () {
                            list.fuzzySearch("");
                        }
                ...
                if (paginationButtonPrev) {
                    paginationButtonPrev.addEventListener(
                        "click",
                        function (e) {
                            e.preventDefault();
                            pageCount -= 1;
                    ...
                    listFilters.forEach(function (listFilter) {
                        listFilter.addEventListener("change", function () {
                            ...
                            listFilters.forEach(function (filter) {
                                var key =
                                    filter.getAttribute("data-list-filter");
                            ...
                            list.filter(function (item) {
                                return Object.keys(activeFilters).every(
                                    function (key) {
                                        // 1. Get the row element
                                        var row = item.elm;

                                        // 2. Find the real cell by class name
                                        var cell = row.querySelector("." + key);

                                        // 3. Extract clear text (badge-safe)
                                        var cellText = cell
                                            ? cell.innerText
                                                  .trim()
                                                  .toLowerCase()
                ...
                //bulk-select
                if (bulkSelect) {
                    var bulkSelectInstance =
                        window.BulkSelect.getInstance(bulkSelect);
                    bulkSelectInstance.attachRowNodes(
                        list.items.map(function (item) {
                            return item.elm.querySelector(
...
var navbarComboInit = function navbarComboInit() {
    ...
    var moveNavContent = function moveNavContent(windowWidth) {
        ...
        if (windowWidth < navbarTopBreakpoint) {
            var navbarCollapse = navbarTopCombo.querySelector(
                Selector.COLLAPSE
            );
            ...
            if (moveableContainer) {
                var _navbarNav = moveableContainer.querySelector(
                    Selector.NAVBAR_NAV
                );
...
var progressAnimationToggle = function progressAnimationToggle() {
    var animatedProgress = document.querySelectorAll(
        "[data-progress-animation]"
    );
    animatedProgress.forEach(function (progress) {
        progress.addEventListener("click", function (e) {
            var progressID = utils.getData(
                e.currentTarget,
                "progressAnimation"
            );
...
var searchInit = function searchInit() {
    ...
    searchAreas.forEach(function (searchArea) {
        ...
        var btnDropdownClose = searchArea.querySelector(
    ...
    themeController.on("click", function (e) {
        ...
        if (target.data("theme-control")) {
            ...
            if (control !== "navbarPosition") {
                Object.prototype.hasOwnProperty.call(CONFIG, control) &&
        ...
        if (tinymces.length) {
            ...
            window.tinymce.init({
                ...
                content_style:
                    "\n          .mce-content-body {\n            color: "
                        .concat(
                            utils.getColors().emphasis,
                            ";\n            background-color: "
                        )
                        .concat(
                            utils.getColor("tinymce-bg"),
                            ";\n          }\n        "
                        ),
                mobile: {
                    theme: "mobile",
                ...
                toolbar:
                    "styles | bold italic link bullist numlist image blockquote table media undo redo",
                    ...
                    function (e) {
                        ...
                        if (striped) {
                            ...
                            if (
                                !e
                                    .composedPath()[2]
                                    .classList.contains(ClassName.TREEVIEW) &&
                                childs.length === 0
                            ) {
...
var wizardInit = function wizardInit() {
    ...
    wizards.forEach(function (wizard) {
        var tabToggleButtonEl = wizard.querySelectorAll(
        ...
        var confirmPasswordInput = wizard.querySelector(
            ...
            tabToggleButtonEl.forEach(function (item, index) {
                ...
                item.addEventListener(events.SHOWN, function () {
                    ...
                    for (var j = count; j < tabToggleButtonEl.length; j += 1) {
                        ...
                        if (j > 0) {
                            tabToggleButtonEl[j - 1].classList.remove(
                                "complete"
                            );
                        }
                    }
        ...
        if (managementEvents) {
            managementEvents.forEach(function (e) {
                managementEventList.push({
                    ...
                    display: "background",
                    classNames: "border border-2 border-".concat(
                        e.classNames,
                        " bg-100"
                    ),
                });
            ...
            managementEvents.forEach(function (e) {
                managementCalendarEvents.innerHTML +=
                    "\n          <li class= 'border-top pt-3 mb-3 pb-1 cursor-pointer' data-calendar-events>\n            <div class= 'border-start border-3 border-"
                        .concat(
                            e.classNames,
                            ' ps-3 mt-1\'>\n              <h6 class="mb-1 fw-semi-bold text-700 hover-primary">'
                        )
                        .concat(
                            e.title,
        ...
        return {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: "Student A",
                        backgroundColor: utils.rgbaColor(
        ...
        var _tooltipFormatter = function _tooltipFormatter(params) {
            return "\n      <div>\n        <p class='mb-2 text-600'>"
                .concat(
                    ...
                    '</p>\n        <div class=\'ms-1\'>\n          <h6 class="fs-10 text-700"><span class="fas fa-circle text-primary me-2"></span>'
                )
                .concat(
                    params[0].value,
                    '</h6>\n          <h6 class="fs-10 text-700"><span class="fas fa-circle text-success me-2"></span>'
                )
                .concat(
                    params[1].value,
                    '</h6>\n          <h6 class="fs-10 text-700"><span class="fas fa-circle text-info me-2"></span>'
                )
                .concat(
                    params[2].value,
                    "</h6>\n        </div>\n      </div>\n      "
                ...
                series: [
                    {
                        type: "line",
                        data: [
                            4164, 4652, 4817, 4841, 4920, 5439, 5486, 5498,
                            5512, 5538, 5841, 5877, 6086, 6146, 6199, 6431,
                            6704, 7939, 8127, 8296, 8322, 8389, 8411, 8502,
                    ...
                    },
                    {
                        type: "line",
                        data: [
                            2164, 2292, 2386, 2430, 2528, 3045, 3255, 3295,
                            3481, 3604, 3688, 3840, 3932, 3949, 4003, 4298,
                            4424, 4869, 4922, 4973, 5155, 5267, 5566, 5689,
                    ...
                    },
                    {
                        type: "line",
                        data: [
                            1069, 1089, 1125, 1141, 1162, 1179, 1185, 1216,
                            1274, 1322, 1346, 1395, 1439, 1564, 1581, 1590,
                            1656, 1815, 1868, 2010, 2133, 2179, 2264, 2265,
    ...
    var tooltipFormatter = function tooltipFormatter(params) {
        ...
        var perTemp =
            '\n      <div class="d-flex align-items-center ms-2">\n        <span class="fas fa-caret-'
                ...
                .concat(
                    ...
                    '"></span>\n        <h6 class="fs-11 mb-0 ms-1 fw-semi-bold">'
                )
                .concat(
        ...
        return "<div>\n          <p class='mb-0 fs-11 text-600'>"
            ...
            .concat(
                ...
                "</p>\n          <div class=\"d-flex align-items-center\">\n            <p class='mb-0 text-600 fs-10'>\n              Users: <span class='text-800 fw-semi-bold fs-10'>"
            )
    ...
    function getFormatter(params) {
        return params
            .map(function (_ref17) {
                ...
                return '<span class= "fas fa-circle fs-11" style="color: '
                    .concat(
                        borderColor,
                        "\"></span>\n            <span class='text-600'>\n              "
                    )
                ...
                series: [
                    {
                        ...
                        type: "line",
                        data: [
                            2000, 2800, 2200, 3001, 600, 600, 2000, 2000, 700,
                            1000, 200, 900, 1200,
                        ],
                        lineStyle: {
                            color: utils.getColor("primary"),
                    ...
                    },
                    {
                        ...
                        type: "line",
                        data: [
                            1700, 1200, 500, 700, 1500, 1100, 700, 1100, 2600,
                            2050, 1050, 600, 700,
                        ],
                        lineStyle: {
                ...
                series: [
                    {
                        type: "line",
                        data: [
                            40, 37, 42, 44, 36, 39, 37, 43, 38, 35, 43, 39, 42,
                            36, 37, 36, 42, 44, 34, 41, 37, 41, 40, 40, 43, 34,
                            41, 35, 44, 41, 40,
                        ],
                        showSymbol: false,
                        symbol: "circle",
            ...
            .concat(
                params
                    .map(function (_ref18) {
                        ...
                        return '\n          <span class= "fas fa-circle fs-11" style="color: '
                            .concat(
                                borderColor,
                                "\"></span>\n          <span class='text-600'>\n            "
                            )
                ...
                series: [
                    {
                        ...
                        z: -1,
                        data: [
                            600, 832, 901, 934, 1290, 1330, 1320, 1250, 1190,
                            1345, 1009, 1320, 600, 832, 901, 934, 1290, 1330,
                            1320, 1250, 1190, 1345, 1009, 1320,
                        ],
                        itemStyle: {
                            emphasis: {
                    ...
                    },
                    {
                        ...
                        barGap: "-100%",
                        data: [
                            320, 420, 800, 100, 1000, 930, 720, 1020, 800, 320,
                            450, 150, 320, 420, 800, 100, 1000, 930, 720, 1020,
                            800, 320, 450, 150,
                        ],
                        itemStyle: {
                            normal: {
                ...
                series: [
                    {
                        ...
                        name: "Closed Amount",
                        data: [
                            0, 5000, 18000, 40000, 58000, 65000, 90000, 110000,
                            140000,
                        ],
                        symbolSize: 5,
                        symbol: "circle",
                    ...
                    },
                    {
                        ...
                        name: "Revenue Date",
                        data: [
                            0, 10000, 24000, 35000, 45000, 53000, 57000, 68000,
                            79000,
                        ],
                        symbolSize: 5,
                        symbol: "circle",
                ...
                tooltip: {
                    ...
                    formatter: function formatter(params) {
                        return '<div class="fw-semibold">'
                            .concat(
                                params.seriesName,
                                '</div><div class="fs-10 text-600"><strong>'
                            )
...
var revenueChartInit = function revenueChartInit() {
    var data = {
        ...
        dataset: {
            revenue: [
                [
                    645, 500, 550, 550, 473, 405, 286, 601, 743, 450, 604, 815,
                    855, 722, 700, 896, 866, 952, 719, 558, 737, 885, 972, 650,
                    600,
                ],
                [
                    440, 250, 270, 400, 175, 180, 200, 400, 600, 380, 340, 550,
                    650, 450, 400, 688, 650, 721, 500, 300, 445, 680, 568, 400,
                    371,
                ],
            ],
            users: [
                [
                    545, 500, 650, 727, 773, 705, 686, 501, 643, 580, 604, 615,
                    755, 722, 727, 816, 836, 952, 719, 758, 937, 785, 872, 850,
                    800,
                ],
                [
                    340, 360, 230, 250, 410, 430, 450, 200, 220, 540, 500, 250,
                    355, 320, 500, 630, 680, 500, 520, 550, 750, 720, 700, 780,
                    750,
                ],
            ],
            deals: [
                [
                    545, 400, 450, 627, 473, 450, 460, 780, 770, 800, 504, 550,
                    500, 530, 727, 716, 736, 820, 719, 758, 737, 885, 872, 850,
                    800,
                ],
                [
                    245, 300, 450, 427, 273, 250, 260, 580, 570, 500, 402, 450,
                    400, 330, 527, 516, 536, 620, 519, 558, 537, 483, 472, 250,
                    300,
                ],
            ],
            profit: [
                [
                    545, 400, 450, 627, 673, 605, 686, 501, 843, 518, 504, 715,
                    955, 622, 627, 716, 736, 952, 619, 558, 937, 785, 872, 550,
                    400,
                ],
                [
                    340, 360, 330, 300, 410, 380, 450, 400, 420, 240, 200, 250,
                    355, 320, 500, 630, 680, 400, 420, 450, 650, 620, 700, 450,
                    340,
                ],
            ],
        },
        ...
        if ($distributionOfPerformance) {
            ...
            var getDefaultOptions = function getDefaultOptions() {
                return {
                    color: [
                        utils.getColor("primary"),
                        utils.isDark() === "dark" ? "#236EA1" : "#7DD7FE",
                    ],
                    legend: {
...
var tooltipFormatter = function tooltipFormatter(params) {
    ...
    params.forEach(function (el) {
        tooltipItem +=
            '<div class=\'ms-1\'>\n        <h6 class="text-700">\n          <span class="fas fa-circle me-1 fs-11" style="color:'
                .concat(
            ...
            if (utils.getData(item, "echart-responsive")) {
                if (
                    !(
                        ...
                        window.getComputedStyle(item.closest(".tab-pane"))
                            .display === "none"
                    )
                ) {
...
var grossRevenueChartInit = function grossRevenueChartInit() {
    ...
    if ($echartsGrossRevenue) {
        ...
        var _tooltipFormatter2 = function _tooltipFormatter2(params) {
            ...
            params.forEach(function (el) {
                tooltipItem +=
                    '<h6 class="fs-10 text-700"><span class="fas fa-circle me-2" style="color:'
        ...
        monthSelect.addEventListener("change", function (e) {
            ...
            $legendCurrentMonth.querySelector(".text").innerText =
                months[month];
            $legendPrevMonth.querySelector(".text").innerText = months[
                month - 1
            ]
                ? months[month - 1]
                : "Dec";
...
var linePaymentChartInit = function linePaymentChartInit() {
    var $echartsLinePaymentChart = document.querySelector(
        ".echart-line-payment"
    );
    var dataset = {
                ...
                tooltip: {
                    ...
                    formatter: function formatter(params) {
                        ...
                        return "<strong>"
                            ...
                            .concat(
                                (
                                    (params.data && params.data.value / total) *
                                    100
                                ).toFixed(2),
                                "%"
                            );
    ...
    if ($numberOfTickets) {
        ...
        var getDefaultOptions = function getDefaultOptions() {
            return {
                color: [
                    utils.getColor("primary"),
                    utils.isDark() === "dark" ? "#1E4C88" : "#94BCF1",
                    utils.isDark() === "dark" ? "#1A3A64" : "#C0D8F7",
                    utils.isDark() === "dark" ? "#225FAE" : "#6AA3ED",
                ],
                tooltip: {
                    trigger: "item",
                    padding: [7, 10],
...
var realTimeUsersChartInit = function realTimeUsersChartInit() {
    var $echartsRealTimeUsers = document.querySelector(
    ...
    if ($echartsRealTimeUsers) {
        ...
        var data = [
            921, 950, 916, 913, 909, 962, 926, 936, 977, 976, 999, 981, 998,
            1000, 900, 906, 973, 911, 994, 982, 917, 972, 952, 963, 991,
        ];
        var axisData = [
...
var salesByPosLocationInit = function salesByPosLocationInit() {
    ...
    if ($echartsRadarSalesByPosLocation) {
        // Get options from data attribute
        var userOptions = utils.getData(
            $echartsRadarSalesByPosLocation,
            "options"
        );
...
var sessionByBrowserChartInit = function sessionByBrowserChartInit() {
    var $sessionByBroswser = document.querySelector(
...
var sessionByCountryChartInit = function sessionByCountryChartInit() {
    var $sessionByCountry = document.querySelector(
...
var ticketVolumeChartInit = function ticketVolumeChartInit() {
    ...
    if ($ticketVolume) {
        ...
        var ticketVolumeLegend = document.querySelectorAll(
            "[data-ticket-volume]"
        );
        var getDefaultOptions = function getDefaultOptions() {
            return {
                color: [
                    utils.getColors().primary,
                    utils.isDark() === "dark" ? "#235FAD" : "#6AA2EC",
                    utils.isDark() === "dark" ? "#1C4477" : "#AACAF4",
                    utils.isDark() === "dark" ? "#152C48" : "#DFEBFB",
                ],
                legend: {
                    data: [
                        "On Hold Tickets",
    ...
    function getFormatter(params) {
        return params
            .map(function (_ref20) {
                ...
                return '\n          <span class= "fas fa-circle" style="color: '
                    .concat(
                        borderColor,
                        "\"></span>\n          <span class='text-600'>"
                    )
                    .concat(
                        seriesName === "lastMonth"
                            ? "Last Month"
                            : "Previous Year",
                        ": "
                    )
...
var echartsUnresolvedTicketsInit = function echartsUnresolvedTicketsInit() {
    var $unresolvedTickets = document.querySelector(
...
var usersByTimeChartInit = function usersByTimeChartInit() {
    var $echartUsersByTimeChart = document.querySelector(
